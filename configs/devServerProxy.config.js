...
const baseUrl = 'https://pr.harness.io/pie-2382-exyaml'
const targetLocalHost = false // (process.env.TARGET_LOCALHOST && JSON.parse(process.env.TARGET_LOCALHOST)) ?? true // set to false to target baseUrl environment instead of localhost
