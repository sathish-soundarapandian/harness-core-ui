          ...
          <div className={css.sectionContent}>
            <Layout.Horizontal spacing="medium" style={{ alignItems: 'center' }}>
              <CustomVariableInputSet
                ...
                initialValues={{ variables: template.infrastructure.variables }}
        ...
        <Container margin={{ bottom: 'medium' }}>
          ...
          <div className={css.sectionContent}>
            <Layout.Vertical spacing="medium" width={'60%'}>
              {template.infrastructure.instanceAttributes.map(
                (instanceAttribute: { name: string; jsonPath: string }, index: number) => {
                  return (
                    <Layout.Horizontal
                      spacing={'medium'}
