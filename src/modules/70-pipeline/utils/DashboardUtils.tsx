...
export const renderTooltipContent = ({
  ...
  return `<div style="padding: 16px; color: white; width: 282px; height: 128px;" onClick=${() => console.log('hi')}>
...
export function TooltipComponent(props: any): React.ReactElement {
  // const {onClick,time,count,failureRate,successCount, failureCount} = props
  return (
    <div style={{ padding: '16px', color: 'white', width: '282px', height: '128px' }} onClick={console.log}>
      hello there
      {/* <div style="display: flex; justify-content: space-between; border-bottom: 0.5px solid rgba(243, 243, 250); padding-bottom: 7px; margin-bottom: 15px;">
    <div style="font-weight: normal; font-size: 12px; line-height: 18px; opacity: 0.8;">{time}</div>
    <div>
...
export const getTooltip = (currPoint: TooltipFormatterContextObject): string => {
  ...
  return renderToString(<TooltipComponent />)
