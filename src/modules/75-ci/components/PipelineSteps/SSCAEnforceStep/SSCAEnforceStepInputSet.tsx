...
import type { SSCAEnforceStepProps } from './SSCAEnforceStep'
import { CIStep } from '../CIStep/CIStep'
import { CIStepOptionalConfig } from '../CIStep/CIStepOptionalConfig'
import css from '@pipeline/components/PipelineSteps/Steps/Steps.module.scss'

export const SSCAEnforceStepInputSetBasic: React.FC<SSCAEnforceStepProps> = ({
  template,
  path,
  readonly,
  stepViewType,
...
const SSCAEnforceStepInputSet = connect(SSCAEnforceStepInputSetBasic)
export { SSCAEnforceStepInputSet }
