...
import type { SSCAOrchestrateStepProps } from './SSCAOrchestrateStep'
import { CIStep } from '../CIStep/CIStep'
import { CIStepOptionalConfig } from '../CIStep/CIStepOptionalConfig'
import css from '@pipeline/components/PipelineSteps/Steps/Steps.module.scss'

export const SSCAOrchestrateStepInputSetBasic: React.FC<SSCAOrchestrateStepProps> = ({
  template,
  path,
  readonly,
  stepViewType,
...
const SSCAOrchestrateStepInputSet = connect(SSCAOrchestrateStepInputSetBasic)
export { SSCAOrchestrateStepInputSet }
