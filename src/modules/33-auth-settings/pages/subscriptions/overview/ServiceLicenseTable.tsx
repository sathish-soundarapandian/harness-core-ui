...
import type { PageActiveServiceDTO, ActiveServiceDTO } from 'services/cd-ng'
...
export function ServiceLicenseTable({
  ...
  const columns: Column<ActiveServiceDTO>[] = React.useMemo(() => {
    ...
    ] as unknown as Column<ActiveServiceDTO>[]
