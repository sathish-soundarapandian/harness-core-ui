...
function getBodyByModule(module: Module): React.ReactElement {
  switch (module) {
    case 'cf': {
      return <FFCurrentSubscription />
    }
    default:
      return <></>
  }
...
export const CurrentSubscription = ({ module, currentPlan }: CurrentSubscriptionProps): React.ReactElement => {
  return (
    <Layout.Vertical padding={{ bottom: 'large' }}>
      <Header currentPlan={currentPlan} />
      {getBodyByModule(module)}
    </Layout.Vertical>
  )
}
