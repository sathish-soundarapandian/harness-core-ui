...
export default function DynatraceCustomMetrics(props: DynatraceCustomMetricsProps): JSX.Element {
	...
	const {
		mutate: querySampleData,
		loading,
		error
	} = useGetDynatraceSampleData({ queryParams: sampleDataQueryParams });
								...
								<NameId
									...
									identifierProps={{
										...
										isIdentifierEditable: Boolean(
											!selectedMetricData?.identifier || selectedMetricData?.isNew
										)
									}}
								/>
								<GroupName
								...
								{metricValues.isManualQuery && !isTemplate && (
									<Container className={css.manualQueryWarning}>
										...
										<Text
											...
											intent="primary"
											onClick={() =>
												formikSetField(DynatraceHealthSourceFieldNames.MANUAL_QUERY, false)
											}
										>
