...
describe('Azure Slot Deployment step', () => {
  ...
  test('Should render edit view as new step', async () => {
    ...
    act(() => await userEvent.type(name!, 'New azure slot deployment'))
