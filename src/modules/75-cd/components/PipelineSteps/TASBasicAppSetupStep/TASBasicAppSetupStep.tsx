...
import { checkEmptyOrNegative, InstancesType } from './TASBasicAppSetupTypes'
...
export class TASBasicAppSetupStep extends PipelineStep<TASBasicAppSetupData> {
  ...
  processFormData(data: TASBasicAppSetupData): TASBasicAppSetupData {
    return data
  }
  ...
  validateInputSet({
    ...
    const errors: FormikErrors<TASBasicAppSetupData> = {}
