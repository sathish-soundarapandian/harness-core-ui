...
// import type { TasServiceSpecFormProps } from './TasServiceSpecInterface'
...
const TasServiceSpecEditable: React.FC<any> = ({
  //TasServiceSpecFormProps
...
export default TasServiceSpecEditable
