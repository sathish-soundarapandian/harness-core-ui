...
import { FormatFilePaths, AllowedTypes, StepTwoTitle } from '../../CloudFormationHelper'
...
const StepTwo: React.FC<StepProps<any> & StepTwoProps> = ({
  ...
  const title = getString(StepTwoTitle(isNumber(index), prevStepData?.selectedConnector === S3))
