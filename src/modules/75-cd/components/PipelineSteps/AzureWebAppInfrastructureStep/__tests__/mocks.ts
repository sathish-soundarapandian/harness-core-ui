...
export const webAppNamesResponse: UseGetReturnData<ResponseAzureWebAppNamesDTO> = {
  loading: false,
  refetch: jest.fn(),
  error: null,
  data: {
    status: 'SUCCESS',
    data: {
      webAppNames: ['azureCdpTestVaibhav']
    },
    correlationId: '80839f3f-8198-46e6-9708-d09e79224922'
  }
}

export const deploymentSlotsResponse: UseGetReturnData<ResponseAzureDeploymentSlotsDTO> = {
  loading: false,
  refetch: jest.fn(),
  error: null,
  data: {
    ...
    data: {
      deploymentSlots: [
        {
          type: 'non-production',
          name: 'azureCdpTestVaibhav-slot1'
        },
        {
          type: 'non-production',
          name: 'azureCdpTestVaibhav-slot2'
        },
        {
          type: 'production',
          name: 'azureCdpTestVaibhav'
        }
      ]
    },
    correlationId: 'aaa8cce0-c2a0-4fe9-996d-91ce1b4aaed4'
  }
}
