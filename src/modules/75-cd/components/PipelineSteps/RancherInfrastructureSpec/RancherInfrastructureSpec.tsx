          ...
          return (
            <FormikForm>
              <CommonKuberetesInfraSpecEditable
                ...
                connectorType={Connectors.Rancher as any}
...
export class RancherInfrastructureSpec extends PipelineStep<RancherInfrastructureSpecStep> {
  lastFetched: number
  protected type = StepType.Rancher
  protected defaultValues: K8sRancherInfrastructure = { cluster: '', connectorRef: '', namespace: '', releaseName: '' }
    ...
    if (pipelineObj) {
      ...
      if (obj?.type === KubernetesRancherType) {
        return getConnectorListV2Promise({
          ...
          body: { types: ['Rancher'], filterType: 'Connector' }
        }).then(response => {
          const data =
