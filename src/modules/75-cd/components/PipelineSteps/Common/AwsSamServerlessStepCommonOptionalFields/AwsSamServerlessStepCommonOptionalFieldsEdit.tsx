    ...
    <>
      ...
      {commandOptionsFieldName && (
        <Container className={cx(stepCss.formGroup)}>
          <MultiTypeList
            name={commandOptionsFieldName} // 'spec.buildCommandOptions' / 'spec.deployCommandOptions'
            multiTextInputProps={{
              expressions,
            ...
            multiTypeFieldSelectorProps={{
              label: getString('optionalField', {
                name: commandOptionsFieldLabel // getString('cd.steps.awsSamBuildStep.awsSamBuildCommandOptions') / getString('cd.steps.awsSamDeployStep.awsSamDeployCommandOptions')
              }),
