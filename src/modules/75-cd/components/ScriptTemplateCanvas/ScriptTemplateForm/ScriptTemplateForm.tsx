...
export default function ScriptTemplateForm(
  ...
  React.useImperativeHandle(formikRef, () => ({
    ...
    getErrors() {
      return selectedTabID === ScriptTemplateFormTabs.Script && scriptRef.current
        ? scriptRef.current.errors
        : selectedTabID === ScriptTemplateFormTabs.Configurations && configfRef.current
        ? configfRef.current.errors
        : {}
    },
