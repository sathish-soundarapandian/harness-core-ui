...
export default function SelectDeploymentType({
  ...
  const { NG_SVC_ENV_REDESIGN, CDS_TAS_NG, CDS_AWS_NATIVE_LAMBDA, CDP_AWS_SAM } = useFeatureFlags()
  ...
  }, [NG_SVC_ENV_REDESIGN, CDS_TAS_NG, CDS_AWS_NATIVE_LAMBDA, CDP_AWS_SAM])
