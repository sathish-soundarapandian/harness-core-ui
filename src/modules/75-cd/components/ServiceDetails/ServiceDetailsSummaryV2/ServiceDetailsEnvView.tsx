...
export function ServiceDetailsEnvView(props: ServiceDetailsEnvViewProps): React.ReactElement {
  ...
  return (
    <Container>
      ...
      {loading ? (
        <Container flex={{ justifyContent: 'center', alignItems: 'center' }} height={250}>
          <Icon name="spinner" color={Color.BLUE_500} size={30} />
        </Container>
      ) : error ? (
        <Container data-test="ActiveServiceInstancesError" height={250} flex={{ justifyContent: 'center' }}>
