...
const getEnabledArtifactTypesList = ({ AZURE_ARTIFACTS_NG, AZURE_WEBAPP_NG_JENKINS_ARTIFACTS }: Params) => {
...
export function ArtifactSourceSpecifications(props: {
  ...
  const { AZURE_ARTIFACTS_NG, AZURE_WEBAPP_NG_JENKINS_ARTIFACTS } = useFeatureFlags()
  ...
  const enabledArtifactTypesList = useMemo(
    ...
    [AZURE_ARTIFACTS_NG, AZURE_WEBAPP_NG_JENKINS_ARTIFACTS]
  )
