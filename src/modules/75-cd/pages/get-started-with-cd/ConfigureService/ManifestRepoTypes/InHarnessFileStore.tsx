...
import { FileStoreNodeDTO, ManifestConfigWrapper, ResponseFileDTO, useCreate, useGetFolderNodes } from 'services/cd-ng'
...
const InHarnessFileStore = ({
      ...
      if (response?.data?.children) {
        ...
        const manifestObj: ManifestConfigWrapper = {
          manifest: {
            ...
            type: formikProps?.values?.manifestData?.type as ManifestTypes,
            spec: {
              store: {
  ...
  return (
    <>
      ...
      {!isEmpty(drawerData?.fileContent) && <RightDrawer isOpen={openFileDrawer} setIsOpen={setOpenFileDrawer} />}
    </>
  )
}
