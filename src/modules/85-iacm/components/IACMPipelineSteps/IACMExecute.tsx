...
export class IACMExecute extends PipelineStep<DefaultIACMProps> {
  constructor() {
    super()
  ...
  protected type = StepType.Execute
  protected stepName = 'IACM Execute'
  protected stepIcon: IconName = 'iacm'
  protected stepDescription: keyof StringsMap = 'iacm.pipelineSteps.executeDescription'
