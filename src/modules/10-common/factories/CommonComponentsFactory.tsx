...
export interface CommonComponentsFactoryProps {
...
class CommonComponentsFactoryProps {
  private componentMap: Map<ListReferredByEntitiesQueryParams['referredEntityType'], ResourceDetailHandler>
...
export default new CommonComponentsFactoryProps()
