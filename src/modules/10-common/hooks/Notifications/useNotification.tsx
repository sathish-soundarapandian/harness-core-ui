...
import css from './useNotification.module.scss'
...
const showPrimary = (message: string | ReactNode, timeout?: number, key?: string): void => {
  toaster.show({ message, intent: Intent.PRIMARY, icon: 'notifications', timeout: 30000 }, key)
}

export function useNotification(): ToasterProps {
  return {
    ...toaster,
    showSuccess,
    showError,
