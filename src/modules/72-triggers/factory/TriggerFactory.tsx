...
import { Nexus2Registry } from '@triggers/components/Triggers/ArtifactTrigger/Nexus2Registry/Nexus2Registry'
...
TriggerFactory.registerTrigger(new Nexus2Registry())
