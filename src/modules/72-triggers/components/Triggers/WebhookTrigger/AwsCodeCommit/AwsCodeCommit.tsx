...
export class AwsCodeCommit extends WebhookTrigger<WebhookInitialValuesInterface> {
  protected type: SourceRepo = SourceRepo.AwsCodeCommit
  protected triggerDescription: keyof StringsMap = 'common.repo_provider.codecommit'
