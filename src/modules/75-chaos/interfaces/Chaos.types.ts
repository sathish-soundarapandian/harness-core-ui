...
import type { LogsContentProps, RenderLogsInterface } from '@pipeline/factories/ExecutionFactory/types'
...
export interface ChaosCustomMicroFrontendProps {
  customComponents: {
    ...
    LogsContentWithErrorBoundary: React.ComponentType<LogsContentProps>
  }
  customHooks: {
