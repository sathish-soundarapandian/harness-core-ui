...
export interface ApiGetInfraResponse {
  ...
  description?: string
  id?: string
  installationDetails?: DatabaseInstallInfraCollection
...
export const useListInfraInstallations = (props: UseListInfraInstallationsProps) =>
  useGet<
    ...
    ListInfraInstallationsQueryParams,
    void
  >(`/api/v1/infras/:infraID/installations`, { base: getConfig('servicediscovery'), ...props })
...
export const useInstallInfra = (props: UseInstallInfraProps) =>
  useMutate<
    ...
    void,
    void
  >('POST', `/api/v1/infras/:infraID/installations`, { base: getConfig('servicediscovery'), ...props })
...
export const useGetInfraInstall = (props: UseGetInfraInstallProps) =>
  useGet<
    ...
    GetInfraInstallQueryParams,
    void
  >(`/api/v1/infras/:infraID/installations/:infraInstallID`, { base: getConfig('servicediscovery'), ...props })
