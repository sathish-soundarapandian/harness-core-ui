...
export interface GetSloMetrcsQueryParams {
  accountId: string
  orgIdentifier: string
  projectIdentifier: string
}

export interface GetSloMetrcsPathParams {
  monitoredServiceIdentifier: string
  healthSourceIdentifier: string
}

export type GetSloMetrcsProps = Omit<
  GetProps<RestResponseListMetricDTO, unknown, GetSloMetrcsQueryParams, GetSloMetrcsPathParams>,
  'path'
> &
  GetSloMetrcsPathParams

/**
 * get slo metrics in a healthSource
 */
export const GetSloMetrcs = ({ monitoredServiceIdentifier, healthSourceIdentifier, ...props }: GetSloMetrcsProps) => (
  <Get<RestResponseListMetricDTO, unknown, GetSloMetrcsQueryParams, GetSloMetrcsPathParams>
...
export type UseGetSloMetrcsProps = Omit<
  UseGetProps<RestResponseListMetricDTO, unknown, GetSloMetrcsQueryParams, GetSloMetrcsPathParams>,
  'path'
> &
  GetSloMetrcsPathParams
 ...
 * get slo metrics in a healthSource
 */
export const useGetSloMetrcs = ({
  monitoredServiceIdentifier,
  healthSourceIdentifier,
  ...props
}: UseGetSloMetrcsProps) =>
  useGet<RestResponseListMetricDTO, unknown, GetSloMetrcsQueryParams, GetSloMetrcsPathParams>(
    (paramsInPath: GetSloMetrcsPathParams) =>
 ...
 * get slo metrics in a healthSource
 */
export const getSloMetrcsPromise = (
  {
    monitoredServiceIdentifier,
    healthSourceIdentifier,
    ...props
  }: GetUsingFetchProps<RestResponseListMetricDTO, unknown, GetSloMetrcsQueryParams, GetSloMetrcsPathParams> & {
    monitoredServiceIdentifier: string
    healthSourceIdentifier: string
  },
  signal?: RequestInit['signal']
) =>
  getUsingFetch<RestResponseListMetricDTO, unknown, GetSloMetrcsQueryParams, GetSloMetrcsPathParams>(
    getConfig('cv/api'),
